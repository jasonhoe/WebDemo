...
(function ($) {
	$.fn.nthTabs =  function(options){
		...
		var template = '<div class="page-tabs"><div class="content-tabs"><div class="content-tabs-container"><ul class="nav nav-tabs"></ul></div></div><li role="separator" class="divider"></li><li class="scrollbar-outer tab-list-scrollbar"><div class="tab-list-container"><ul class="tab-list"></ul></div></li></ul></div></div><div class="tab-content" style="padding:20px"></div>';
		//各种api
		var methods = {
			//初始化
			init:function () {
